<x-app-layout>
    ...
    <div class="w-full text-center py-32">
        <h1 class="text-2xl md:text-3xl font-bold text-center lg:text-5xl text-gray-700">
            Welcome to <span class="text-yellow-500">&lt;Ozb&gt;</span> <span class="text-gray-900"> News</span>
        </h1>
    ...
    <div class="mb-10">
        <div class="mb-16">
            ...
            <a class="mt-10 block text-center text-lg text-yellow-500 font-semibold" href="#">More Posts
            </a>
        </div>
        <hr>
